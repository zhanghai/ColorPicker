...
package me.zhanghai.android.colorpicker;
...
import me.zhanghai.android.colorpicker.ColorPickerSwatch.OnColorSelectedListener;

/**
 * A dialog which takes in as input an array of colors and creates a palette allowing the user to
 * select a specific color swatch, which invokes a listener.
 */
public class ColorPickerDialogFragment extends AppCompatDialogFragment implements OnColorSelectedListener {
    ...
    public static ColorPickerDialogFragment newInstance(int titleResId, int[] colors, int selectedColor,
            int columns, int size) {
        ColorPickerDialogFragment ret = new ColorPickerDialogFragment();
